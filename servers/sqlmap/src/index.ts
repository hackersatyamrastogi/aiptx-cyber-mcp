...
server.tool(
    ...
    "Run sqlmap with specified URL",
    {
        ...
        sqlmap_args: z.array(z.string()).optional().default(['--batch']).describe(`Optional SQLmap arguments. Defaults to '--batch' for non-interactive mode. 
